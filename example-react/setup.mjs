// Idempotent seed script. Runs before `vite` via the `dev` script.
// Reads agent-ready.config.json (or legacy llms-txt.config.json) and calls
// agentReady:content:sync on the local deployment.
